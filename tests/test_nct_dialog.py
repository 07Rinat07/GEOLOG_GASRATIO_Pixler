...
def make_controller() -> NctCalculationController:
    ...
    dataset.upsert_curve("DEXPC", np.array([1.0, 1.1, 1.2, 0.9]), unit="dimensionless")
...
def test_nct_dialog_calculates_and_localizes(qapp) -> None:
    dialog = NctCalculationDialog(make_controller(), 1000.0, 1300.0, language=AppLanguage.EN)
