...
Текущая тестовая версия: **0.7.50**. Переключение рабочих форм больше не использует
уничтоженные Qt-виджеты: отложенные изменения шапки останавливаются перед удалением,
а откат полностью пересоздаёт последнюю рабочую форму из сохранённой модели.
