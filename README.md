...
Текущая тестовая версия: **0.7.53**. Инженерные шкалы в шапках получили контрастную
подпись единицы и типа шкалы, панель интервальной статистики стала компактнее, а устаревшие
Qt-графики безопасно исключаются из навигации и обработки событий. Пакет журналов для анализа
создаётся через меню «Справка».
