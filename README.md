...
- **Газовый каротаж и расчёты.** Gas Ratio, суммарный и нормализованный газ,
  ...
  lag/depth-коррекция и пользовательские формулы; отдельная вкладка находит относительные
  газовые аномалии по всей скважине и выпускает XLSX/DOCX/PDF-отчёт для проверки геологом.
