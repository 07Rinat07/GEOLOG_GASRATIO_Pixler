...
Текущая тестовая версия: **0.7.49**. Новые и автоматически созданные кривые используют линейную шкалу; изменение minimum/maximum в шапке сразу перестраивает график. Шапка сохраняет оба предела, единицу и тип шкалы даже в узкой колонке, а неудачное переключение формы автоматически возвращает последнюю рабочую конфигурацию.
