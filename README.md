...
- **Полный геологический отчёт и печать.** Описание пород по каждому метру и каждому
  ...
  экспорт доступен в PDF, XLSX и DOCX. Общая система печати поддерживает A4/A3/рулонные
  носители, физическую печать и PDF, PNG, JPEG, TIFF, BMP, WebP, SVG, CSV, XLSX, DOCX и HTML.
