...
Текущая тестовая версия: **0.7.54**. Шапки кривых используют единую фиксированную
геометрию, рабочий переключатель `лин./лог.` убран в полные настройки, инженерная шкала получила
контрастные подписи, а всплывающие подсказки и карандаш показывают человекочитаемые названия.
Пакет журналов для анализа создаётся через меню «Справка».
