...
Текущая тестовая версия: **0.7.45**. Добавлены сохраняемые рабочие формы, независимая сетка и шкалы каждой графической колонки, прозрачные обозначения и безопасное ежедневное наращивание выбранного DEPTH/TIME dataset.
