...
- **Газовый каротаж и расчёты.** Gas Ratio, суммарный и нормализованный газ,
  ...
  газовые аномалии по всей скважине, выпускает XLSX/DOCX/PDF-отчёт и строит временную
  разгонку принесённой газовой пробы с предварительной категорией флюида. Изолированный
  режим ОПУС принимает C1–C5 в `%`/`ppm`, выделяет интервалы по всей глубине и автоматически
  подписывает рабочую гипотезу: сначала по единственному согласованию опубликованных
  диапазонов ОПУС, при неоднозначности — по явно отмеченному резерву Haworth/Pixler.
...
- **Формы и Masterlog.** Шесть рабочих глубинных/временных форм без дублей, автоматические
  пары A4-шапок для книжной и альбомной печати, пользовательские шаблоны, конструктор колонок,
  условные обозначения, изображения и воспроизводимое сохранение структуры.
