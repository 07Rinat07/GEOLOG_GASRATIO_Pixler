...
Текущая тестовая версия: **0.7.46**. Исправлено открытие LAS после регрессии сетки, добавлены безопасный табличный fallback и сохраняемые диагностические отчёты импорта; рабочие формы и ежедневное наращивание DEPTH/TIME datasets сохранены.
