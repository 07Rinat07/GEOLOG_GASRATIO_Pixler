...
- ISO-8601 индекс CSV/TXT с безопасной UTC-нормализацией и сохранением timezone provenance;
...
- безопасный редактор WELL/PARAMETER с Undo/Redo, проверкой координат и синхронизацией
  имени скважины; STRT/STOP/STEP/NULL защищены от рассогласования с данными.
