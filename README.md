...
Текущая тестовая версия: **0.7.48**. Шапка каждой обычной кривой показывает полноценную инженерную шкалу, единицу измерения, линейный/логарифмический режим и редактируемые minimum/maximum; деления совпадают с сеткой колонки и сохраняются в рабочей форме.
