...
_TEXT: dict[str, dict[str, str]] = {
    ...
    "bit": {"ru": "Диаметр долота", "kk": "Қашау диаметрі", "en": "Bit diameter"},
    ...
    return _factory(
        ...
        [
            ...
            _curve_column(
                ...
                [
                    _binding("TOTAL_GAS", _t("total_gas", language), "%", "#b91c1c"),
                    _binding("TG_CALC", _t("total_gas", language), "%", "#dc2626"),
                    _binding(
                        "TG_NORM",
        ...
        [
            ...
            _curve_column(
                ...
                [
                    ...
                    _binding("BIT", _t("bit", language), "in", "#2563eb"),
                    _binding("FLOW_IN", _t("flow_in", language), "L/s", "#0891b2"),
                ],
                300,
            ),
            _curve_column(
                ...
                [
                    ...
                    _binding("TG_CALC", _t("total_gas", language), "%", "#dc2626", width=2.0),
                    _binding(
                        "TG_NORM",
                        _t("normalized_total_gas", language),
                        "normalized gas units",
                    ...
                    _binding("C2_NORM", "C2_NORM", "normalized gas units", "#16a34a"),
                    _binding("C3_NORM", "C3_NORM", "normalized gas units", "#ea580c"),
                ],
                400,
            ),
            _curve_column(
                ...
                "C4–C5 NORM",
                [
                    _binding("IC4_NORM", "iC4_NORM", "normalized gas units", "#9333ea"),
                    _binding("NC4_NORM", "nC4_NORM", "normalized gas units", "#7c3aed"),
                    _binding("IC5_NORM", "iC5_NORM", "normalized gas units", "#be123c"),
                    _binding("NC5_NORM", "nC5_NORM", "normalized gas units", "#9f1239"),
                ],
                320,
            ),
        ],
