...
class UserProfileSettings:
    ...
    def print_export_preferences(self) -> PrintExportPreferences:
        ...
        try:
            ...
            defaults_version = int(payload.get("defaults_version", 1))
            raw_header_selection_explicit = payload.get("header_selection_explicit", False)
            ...
            return PrintExportPreferences(
                ...
                auto_units_per_page=bool(payload.get("auto_units_per_page", False)),
            ...
            json.dumps(
                {
                    ...
                    "auto_units_per_page": value.auto_units_per_page,
