"""Frozen project codec v29 for supplier rock-profile revisions and source bindings.
...
class ProjectDocument(_v28.ProjectDocument):
    ...
    rock_code_source_bindings: dict[str, RockCodeSourceBindingRecord] = field(default_factory=dict)
