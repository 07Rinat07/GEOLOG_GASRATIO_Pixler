...
_EDITABLE_FIELDS: tuple[HeaderFieldDefinition, ...] = (
    ...
    HeaderFieldDefinition("header.interval_start", "Начало исследований, м", "Зерттеу басы, м", "Survey start, m"),
    HeaderFieldDefinition("header.interval_end", "Конец исследований, м", "Зерттеу соңы, м", "Survey end, m"),
    HeaderFieldDefinition("header.geologists", "Геологи", "Геологтар", "Geologists", multiline=True),
