...
_TEXT = {
    ...
    AppLanguage.EN: {
        "title": "TIME↔DEPTH profiles", "saved": "Saved profiles", "new": "New profile",
        "name": "Name", "time": "TIME index", "depth": "DEPTH index",
        "policy": "Repeated passes", "save": "Save", "delete": "Delete",
        "value": "Time to test", "resolve": "Resolve depth", "close": "Close",
        "empty": "New profile",
        "result": "Depth: {depth:g}; row: {row}; matches: {count}; distance: {distance:g}",
    },
    AppLanguage.KK: {
        "title": "TIME↔DEPTH профильдері", "saved": "Сақталған профильдер",
        "new": "Жаңа профиль", "name": "Атауы", "time": "TIME индексі",
        "depth": "DEPTH индексі", "policy": "Қайталама өтулер", "save": "Сақтау",
        "delete": "Жою", "value": "Тексеру уақыты", "resolve": "Тереңдікті анықтау",
        "close": "Жабу", "empty": "Жаңа профиль",
