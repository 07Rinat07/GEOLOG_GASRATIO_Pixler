...
replace_once(
    "src/geoworkbench/domain/models.py",
...
replace_once(
    "src/geoworkbench/storage/project_codec.py",
...
replace_once(
    "src/geoworkbench/storage/project_migrations.py",
...
'''
Path("tests/test_gas_conditioning_qc_persistence.py").write_text(test_content, encoding="utf-8")

for temporary in (
    ".github/workflows/gas06-persistence-patch.yml",
    ".github/workflows/gas06-persistence-pr-patch.yml",
    ".github/scripts/gas06_persistence_patch.py",
):
