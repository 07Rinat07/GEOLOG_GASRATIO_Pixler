...
| PRINT-003 | Конструктор шапки, легенды и печатного мастерлога | готов базовый конструктор: независимые шаблоны шапки, preview, depth/curve/stratigraphy/lithology/cuttings/calcimetry/LBA/lithology-description/cuttings-description колонки; автолегенда остаётся отдельным улучшением |
...
| PRINT-014 | Автолегенда литотипов, symbols/shows и peak callouts | частично: ручные интерактивные callouts с привязкой к точке/интервалу, управлением и PDF готовы; автоматический поиск пиков и разнесение подписей запланированы |
...
| PRINT-021 | Закрепление интерактивного запроса как управляемой печатной PDF-выноски | готово: хранение в проекте, preview/print/PDF renderer и список удаления для конкретной формы |
| VIEW-001 | Синхронная визирная линия по всем трекам планшета | готово: установка и drag мышью, ближайшие значения видимых кривых и литологии, панель параметров, профильные цвет/толщина/состояние и последняя глубина отдельно для dataset |
| VIEW-002 | Интерактивный планшетный трек процентной шламограммы | готово: stacked 0–100% компоненты с цветами/паттернами литотипов, ручное добавление, default layout и состав под визиром |
