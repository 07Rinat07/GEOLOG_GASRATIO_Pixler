...
| PRINT-021 | Прямое редактирование колонки из шапки Masterlog и выбор кривых активного LAS | готово: double-click по шапке, чеклист параметров и сохранение в шаблоне |
