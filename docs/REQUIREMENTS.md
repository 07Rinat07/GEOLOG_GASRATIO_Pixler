...
| EDIT-018 | Читаемое и редактируемое представление малых чисел | готово: отдельная display/edit точность, десятичная запись без scientific notation и сохранение числового типа |
...
| EXPORT-002 | CSV/TXT выбранного интервала и выбранных кривых | готово для CSV через синхронное выделение таблицы/графика; малые числа записываются десятично без `E±n` |
| EXPORT-003 | Excel с листами Data и Metadata для выбранного интервала | готово: числовые ячейки с десятичным форматом, DATETIME как тип Excel с форматом даты/времени и автодобавление TIME к DEPTH-экспорту |
