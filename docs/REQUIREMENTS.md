...
| VIEW-003 | Планшетная визуализация интерпретационных интервалов | готово: отдельный трек активной интерпретации, полосы по типам, hit-testing по глубине, синхронное выделение с менеджером/деревом и редактируемая панель свойств |
