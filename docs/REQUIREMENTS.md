...
| CALC-015 | Изолированный расчет ОПУС C1–C5 с поддержкой ppm и `% об.` без изменения стандартных методов | готово: source protection, точное UOM-приведение, рабочие/относительные кривые, четыре фактчекингом подтверждённых индекса и контрольные примеры |
...
| EXPORT-018 | Отдельный отчёт ОПУС по всей глубине скважины | готово: отдельный UI-режим, XLSX/DOCX/PDF/печать, полный глубинный ряд, интервальные доказательства, ограничения применимости и запрет недоказанного вывода о продуктивности |
