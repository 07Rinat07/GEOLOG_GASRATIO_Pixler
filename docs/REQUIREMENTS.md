...
| I18N-004 | Актуальные пользовательские инструкции на RU/KK/EN | готова синхронная структура из 34 документов на язык; проверка содержания обязательна при каждом пользовательском изменении |
