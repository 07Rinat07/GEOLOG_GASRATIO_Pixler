...
| PRINT-003 | Конструктор шапки, легенды и печатного мастерлога | готов базовый конструктор: независимые шаблоны шапки, preview, depth/curve/stratigraphy/lithology/cuttings/calcimetry/LBA/description колонки; автолегенда остаётся отдельным улучшением |
