...
| GEO-007 | ЛБА, кальциметрия/карбонатность, керн и стратиграфия | частично: готовы интервальный ввод кальцита/доломита и полей ЛБА, хранение, планшет, Masterlog/PDF и запрос по точке; керн и стратиграфия остаются |
...
| PRINT-003 | Конструктор шапки, легенды и печатного мастерлога | готов базовый конструктор: независимые шаблоны шапки, preview, depth/curve/lithology/cuttings/calcimetry/LBA/description колонки; автолегенда остаётся отдельным улучшением |
