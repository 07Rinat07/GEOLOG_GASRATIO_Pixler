...
| GEO-004 | Описание пород и шаблоны RU/KZ/EN с произвольным форматированным текстом | готово: отдельный интервальный редактор, точные границы, готовые шаблоны, повторное открытие и безопасное удаление только описания |
