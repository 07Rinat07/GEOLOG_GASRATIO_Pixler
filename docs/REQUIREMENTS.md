...
| VIEW-001 | Синхронная визирная линия по всем трекам планшета | готово: установка и drag мышью, ближайшие значения видимых кривых, панель параметров, профильные цвет/толщина/состояние |
