...
| I18N-004 | Актуальные пользовательские инструкции на RU/KK/EN | готова синхронная структура из 41 документа на язык; проверка содержания обязательна при каждом пользовательском изменении |
