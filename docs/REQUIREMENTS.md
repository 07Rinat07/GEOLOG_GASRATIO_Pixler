...
| GEO-004 | Описание пород и шаблоны RU/KZ/EN с произвольным форматированным текстом | готово: отдельный интервальный редактор, точные границы, шаблоны, выравнивание слева/по центру/справа, автоперенос и автомасштаб, повторное открытие и безопасное удаление только описания |
