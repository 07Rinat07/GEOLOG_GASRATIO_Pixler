...
| I18N-003 | Единые переводы интерфейса, ошибок, отчётов и Print Studio | частично: каталог, LAS export UI, печатный словарь и полный набор встроенных форм/готовых A4-шапок проверены на RU/KK/EN; остальные экраны мигрируют поэтапно |
