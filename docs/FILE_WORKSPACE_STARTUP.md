...
При отсутствии зависимости приложение больше не должно аварийно завершаться: вместо редактора во вкладке отображается команда восстановления окружения. Для полноценной проверки после установки откройте любой PDF и убедитесь, что отображается первая страница и доступны кнопки объединения и разделения.
