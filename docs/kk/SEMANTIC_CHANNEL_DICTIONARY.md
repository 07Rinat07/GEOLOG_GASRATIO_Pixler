...
нәтиже береді. `ImportReviewController` plan, preview және тексерілген commit-ті dataset-тің терең
көшірмесінде орындайды. Диалог index, NULL, channel inclusion, canonical mapping, quantity class
және UOM overrides ұсынады. Project-session port-қа тек расталған көшірме беріледі; бас тарту
жобаны өзгертпейді. Толығырақ: [IMPORT_REVIEW.md](IMPORT_REVIEW.md).
