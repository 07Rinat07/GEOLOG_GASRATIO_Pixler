...
`Wits0RawRetentionManager` fail-closed режимінде жұмыс істейді. Ол тек жарамды
`.geoworkbench-wits0-owned.json` marker-і бар қалтадағы белсенді емес `.wits` сегменттері мен белгілі
`.chunks.jsonl`/`.meta.json` sidecar файлдарын ғана жоя алады. Marker resolved path-қа байланыстырылған,
сондықтан оны басқа қалтаға көшіру жою құқығын бермейді. Жаңа бос raw қалтасы автоматты белгіленеді;
бос емес қалтаны қабылдау үшін оператордың айқын растауы қажет. Marker жоқ, бұзылған, көшірілген
немесе қолдау көрсетілмеген болса, жою толық тоқтайды, бірақ capture жалғаса алады. Белсенді сегмент,
journal, recovery manifest, бөгде файлдар және project retention нысаны емес.
