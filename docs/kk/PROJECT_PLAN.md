...
- [x] Ruff және mypy қателерін нөлге жеткізу; толық pytest нәтижесі — 1205 өтті,
...
- import jobs, print jobs, session binding және қалған workspace командаларын шығару;
