...
- [x] Ruff және mypy қателерін нөлге жеткізу; толық pytest нәтижесі — 1182 өтті,
...
- алдымен `TabletView` ішінен annotation event router-ді мінез-құлықты өзгертпей бөліп,
  headless тесттермен қорғау;
- кейін навигация, жол өмірлік циклі, тор және өңдеу режимдерін бөлу;
