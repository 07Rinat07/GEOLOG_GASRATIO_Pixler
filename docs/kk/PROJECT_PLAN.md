...
- [x] Ruff және mypy қателерін нөлге жеткізу; толық pytest нәтижесі — 1211 өтті,
...
- форматтық import jobs орындауын, print jobs, session binding және қалған командаларды шығару;
