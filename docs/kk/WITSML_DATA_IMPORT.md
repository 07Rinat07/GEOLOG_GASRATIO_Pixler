...
шығатын `FileUri`, шифрланған архив member, қайталанатын жол және күмәнді compression ratio-ны
қабылдамайды. XML streaming блоктармен оқылады және толық tree жадта құрылмай тұрып byte өлшемі,
тереңдік, element, мәтін немесе attribute лимиті асса тоқтайды. Row, cell және сыртқы data payload
үшін бөлек лимиттер бар. ZIP/EPC мүшелері дискідегі еркін жолға шығарылмайды.
