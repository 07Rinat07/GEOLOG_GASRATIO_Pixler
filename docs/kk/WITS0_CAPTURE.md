...
3. Басқа компьютер үшін сенімді интерфейстің нақты IP адресін көрсетіңіз. `0.0.0.0` тек
   оқшауланған сенімді желіде, firewall allowlist және айқын шешім болғанда қолданылады.
4. GSWITS қосылатын портты көрсетіңіз.
5. Raw каталогын таңдап, **Қабылдауды бастау** түймесін басыңыз.
6. GSWITS баптауларын сақтап, қосылым күйін тексеріңіз.

WITS0 ішінде кірістірілген encryption және authentication жоқ. Listener-ді интернетке ешқашан
ашпаңыз және router port forwarding баптамаңыз.
...
- WITS0 портын интернетке ашуға болмайды; remote bind тек оқшауланған сенімді желіде firewall
  allowlist арқылы рұқсат етіледі;
