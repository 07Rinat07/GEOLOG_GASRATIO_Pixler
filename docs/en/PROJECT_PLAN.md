...
- [x] bring Ruff and mypy to zero errors; the full pytest result is 1,205 passed and
  10 skipped;
...
- extract import jobs, print jobs, session binding, and the remaining workspace commands;
