...
| Calculations | Gas Ratio/Haworth/Pixler, normalized gas, DEXP/NCT, isolated OPUS for percent/ppm, show detection and automatic interpretation | [Mud-gas interpretation](MUD_GAS_INTERPRETATION.md), [User guide](README.md) |
...
| Reports | interpretation workspace, dynamic OPUS report with formulas/sources and an explicit Haworth/Pixler fallback, XLSX/DOCX/PDF/print, shared-report definition and passport | [Mud-gas interpretation](MUD_GAS_INTERPRETATION.md), [Report definition](REPORT_DEFINITION.md), [Passport](REPORT_PASSPORT.md) |
