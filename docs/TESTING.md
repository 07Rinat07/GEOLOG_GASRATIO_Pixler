...
Для hotfix 0.7.54 в текущем контейнере выполнены `compileall`, focused
header/tooltip/form-набор — **67 passed**, и доступная headless-регрессия —
**1061 passed, 4 skipped, 4 deselected**. Реальный pyqtgraph render требует Windows/PySide6
проверки.
