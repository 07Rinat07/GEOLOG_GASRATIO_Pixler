...
Для hotfix 0.7.55 в текущем контейнере выполнены `compileall`, focused
header/form/constructor-набор — **86 passed**, и доступная headless-регрессия —
**1064 passed, 4 skipped, 4 deselected**. Реальный pyqtgraph render требует Windows/PySide6
проверки.
