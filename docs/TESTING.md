...
Текущий baseline аудита: Ruff — 6 ошибок; mypy — 142 ошибки в 33 файлах; pytest собирает
1169 тестов, но не проходит. Первый изолированный failure — отсутствие
`TabletView._annotation_ancestor` в маршрутизации аннотаций.
