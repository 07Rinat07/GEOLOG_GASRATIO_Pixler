...
Для hotfix 0.7.53 в текущем контейнере выполнены `compileall`, focused
scale/statistics/lifecycle-набор — **49 passed**, и доступная headless-регрессия —
**1039 passed, 4 skipped, 3 deselected**. Qt-виджеты панели и реальный pyqtgraph render требуют
Windows/PySide6 проверки.
