...
- Samples outside a configured linear or logarithmic curve range must remain a visual gap; they must not be clamped to a track edge and turned into artificial strokes or dots.
