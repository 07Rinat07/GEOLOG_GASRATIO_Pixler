...
- [ ] **WELL-02 — единое обновление данных скважины** (WFLOW-002; после WELL-01).
  ...
  изменения данных. До закрытия WELL-02 остаются application/UI workflow отдельных анализов,
  проверка сохранения/rollback на этой mutation boundary, пользовательские рисунки и явное
  разрешение оставшихся конфликтов профилей PROJ-09.
