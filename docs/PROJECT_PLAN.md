...
- [ ] **OPUS-01:** перенести из `Газомер.xls` пять формул, все границы кодов и один численный
...
- [ ] **OPUS-02:** реализовать versioned профиль `OPUS Gasomer` с нормализацией
...
- [ ] **OPUS-03:** заменить непригодные для многокилометрового LAS независимые MAX на
...
- [ ] **OPUS-04:** реализовать адаптивный детектор по локальному фону TotalGas, `ΔTG`, robust z
  и контрасту с LOD-floor. Условие `0,1 % об.` оставить предупреждением доверия, но не hard gate
  поиска или классификации.
- [ ] **OPUS-05:** расширить report model и UI: прямой результат Gasomer, независимый
...
- [ ] **OPUS-06:** добавить regression matrix для формул, границ, `%`/ppm, нулей/LOD, ничьих,
  смены локального фона, синхронности глубин, совместимости старых методов и идентичности
  экспортов.
- [ ] **OPUS-07:** проверить производительность на 25k/100k/1M строк с линейным временем и
