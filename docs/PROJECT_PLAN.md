...
- [ ] **WELL-03 — ввод RU/KK/EN и многоязычные шаблоны** (WFLOW-003; после WELL-01/02).
  ...
  добавляет соответствующий блок во все три языка. Контроллер сохраняет все версии в одной
  операции; следующие инкременты добавят устойчивые ID/версии блоков и охват остальных типов
  интервалов.
