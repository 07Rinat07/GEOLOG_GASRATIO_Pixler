...
- заводские MASTERLOG A4 portrait/landscape используют локализованное отображаемое название
  «Шламограмма» для системной колонки `INTERPRETATION`; книжная форма содержит эту колонку и
...
- [x] **CUT-05:** в обе заводские формы MASTERLOG A4 включена системная колонка
  `INTERPRETATION` с названием «Шламограмма»; книжные ширины перераспределены до `714/718 px`,
