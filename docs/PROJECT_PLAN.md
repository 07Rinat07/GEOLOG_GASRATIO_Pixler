...
- [ ] **PROJ-02:** dirty close guard уже предлагает сохранить проект, экспортировать LAS-копию,
  закрыть без сохранения либо отменить. Остались autosave после материальных операций и
  ротационные backup с проверяемым восстановлением после сбоя.
