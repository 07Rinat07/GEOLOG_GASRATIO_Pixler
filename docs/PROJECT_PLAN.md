...
- [x] выполнить полный набор: 1211 тестов пройдено, 10 пропущено, процесс завершён с кодом 0;
...
261 файле, полный pytest зелёный. Сборка остаётся тестовой до ручного smoke-test.
...
- [ ] вынести выполнение форматных import jobs, print jobs, session binding и оставшиеся
  workspace-команды;
