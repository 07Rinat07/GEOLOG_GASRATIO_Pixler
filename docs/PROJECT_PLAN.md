...
262 файлах, полный pytest зелёный. Сборка остаётся тестовой до ручного smoke-test.
...
- [x] вынести выполнение подтверждённых CSV/Excel планов и регистрацию dataset в
  `TabularImportJobExecutor`;
- [ ] вынести LAS/Paradox jobs, print jobs, session binding и оставшиеся workspace-команды;
