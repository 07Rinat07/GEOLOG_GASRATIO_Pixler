...
- [ ] вынести print jobs, session binding и оставшиеся workspace-команды;
...
Критерий текущих срезов выполнен: маршрутизация аннотаций, навигация, инженерная сетка и
LAS/CSV/Excel/Paradox import jobs проверяются независимо от главного окна; Qt-обработчики
не выполняют форматный импорт и не регистрируют dataset напрямую.
