...
- [x] выполнить полный набор: 1188 тестов пройдено, 10 пропущено, процесс завершён штатно;
...
- [ ] затем выделить из `TabletView` track lifecycle, grid renderer и edit-mode controller;
...
и команды навигации проверяются headless-тестами без создания главного окна.
