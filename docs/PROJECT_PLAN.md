...
этот файл содержит актуальную очередь и критерии приёмки. Срочный рабочий срез 0.7.45
закрывает сохраняемые формы, графические колонки, обозначения и безопасное ежедневное наращивание LAS;
следующий предметный срез возвращается к offline WITSML 2.1 inventory и mapping fixtures.
