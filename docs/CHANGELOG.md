...
- Добавлена вкладка «Отчёты по интерпретации»: единый безопасный расчёт Gas Ratio/Haworth/Pixler, `C1_NORM`, `DEXP/DEXPC`, отдельные планшетные дорожки, поиск относительных газовых аномалий по всей скважине и экспорт кандидатов/ручных интервалов в XLSX, DOCX, PDF и на принтер. Проведена ревизия legacy Excel/Word-методик; ошибочные формулы с пропущенными C4/C5 и старые hardcoded-классификации не перенесены.
