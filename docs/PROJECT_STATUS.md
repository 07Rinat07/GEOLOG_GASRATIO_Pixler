...
|---|---|
| Полный pytest | 1182 пройдено, 10 пропущено; аварийного завершения Qt/Python нет |
| Ruff | все проверки пройдены |
| mypy | 0 ошибок в 256 исходных файлах |
...
После этого следующий вертикальный срез — выделение annotation event router из `TabletView`
с сохранением поведения и headless-тестами; новые предметные модули до этой точки не добавляются.
