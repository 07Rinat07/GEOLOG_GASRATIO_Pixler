...
`GS2#101.db` содержит TIME, DEPTH и 206 каналов на сетке 0,2 м. Чтение `GS2.mdb` и автоматическое
объединение многочастных временных таблиц остаются активными этапами плана.
