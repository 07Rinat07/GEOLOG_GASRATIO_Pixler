...
Статус: реализовано в версии 0.7.41. Project format: v17.
...
Следующий незакрытый срез — append-only growing dataset, checkpoint и детерминированный replay.
Он должен воспроизводить те же events, QC flags и отчётный результат.
