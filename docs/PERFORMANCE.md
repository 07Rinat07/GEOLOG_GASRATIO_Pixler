...
После принятия первого зелёного Windows release-gate его JSON является исходной наблюдаемой
точкой для дальнейших сравнений. Любое последующее изменение benchmark fixture, сценария,
числа повторений или guardrails должно обновляться в одном PR вместе с этим документом и
