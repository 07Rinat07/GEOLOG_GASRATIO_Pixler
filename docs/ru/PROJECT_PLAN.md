...
- [x] довести Ruff и mypy до нулевого числа ошибок; полный pytest: 1205 пройдено,
  10 пропущено;
...
- [x] вынести общий renderer сетки экрана/печати и частичное обновление делений;
...
- вынести import jobs, print jobs, session binding и остальные workspace-команды;
