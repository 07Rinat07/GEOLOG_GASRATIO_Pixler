...
- [x] довести Ruff и mypy до нулевого числа ошибок; полный pytest: 1182 пройдено,
  10 пропущено;
...
- первым срезом выделить annotation event router из `TabletView` без изменения поведения
  и покрыть его headless-тестами;
- затем разделить навигацию, жизненный цикл треков, сетку и режимы редактирования;
