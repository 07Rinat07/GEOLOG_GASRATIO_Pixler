...
Актуально на 24 июля 2026 года. Hotfix 0.7.47 восстанавливает GeoScape/Paradox DB
со смешанным порядком индекса и делает диапазон кривой редактируемым прямо в шапке.
Project format остаётся v20; после Windows-подтверждения следующий предметный срез —
