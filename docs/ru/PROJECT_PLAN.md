...
- исправить маршрутизацию аннотаций и аварийное завершение полного Qt-теста;
- довести Ruff, mypy и все 1169 тестов до нулевого числа ошибок;
...
- разделить `TabletView` на контроллеры аннотаций, навигации, треков, сетки и редактирования;
