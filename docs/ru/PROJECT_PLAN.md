...
- [x] довести Ruff и mypy до нулевого числа ошибок; полный pytest: 1211 пройдено,
  10 пропущено;
...
- вынести выполнение форматных import jobs, print jobs, session binding и остальные команды;
